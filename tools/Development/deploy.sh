...
dotnet publish Todomorrow.sln -c release -o $basedir/dist
...
aws cloudformation package \
  ...
  --s3-bucket todomorrow-development \
  --s3-prefix cloud-formation/todomorrow/$lowercaseEnvironment

aws cloudformation deploy \
  --stack-name todomorrow-$lowercaseEnvironment \
